...
read_verilog -library xil_defaultlib {
  ...
  C:/Users/Hamza/Desktop/riscv-single-cycle/riscv_single_cycle/riscv_single_cycle.srcs/sources_1/new/CPU_FPGA.v
}
...
synth_design -top CPU_FPGA -part xc7a100tcsg324-1


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef CPU_FPGA.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file CPU_FPGA_utilization_synth.rpt -pb CPU_FPGA_utilization_synth.pb"
